...
paginate: false
lang: pt-BR
title: O gênio e o escritório — 60 min
---

<!-- _class: cena centro -->

![bg brightness:0.9](img/gerada/capa-harness.jpg)
...
<!--
⏱ 00:00–03:00 · BLOCOS 0 E 1 · ABERTURA E A GRANDE DÚVIDA
...
ANTES DA AULA
- Versão de 60 min: o exercício vira demonstração guiada de 8 min, no seu notebook, no projetor. Antigravity já instalado e logado.
- Pasta Consultor-Ademicon ainda vazia, para montar ao vivo.
-->
...
<div class="icone"><img src="img/icone-contexto.svg">Contexto</div>
<div class="icone"><img src="img/icone-intencao.svg">Intenção</div>
<div class="icone"><img src="img/icone-papel.svg">Papel</div>
<div class="icone"><img src="img/icone-objetivos.svg">Objetivos</div>
<div class="icone"><img src="img/icone-e-nao-e.svg">É · Não é</div>
</div>

<!--
⏱ 06:00–13:00 · BLOCOS 3 E 4 · PROMPT = PEDIDO · ESTRUTURA
...
Bloco 4 (09:00–13:00), um exemplo de consórcio por ícone
...
<div class="lado">
<div>
<div class="icone"><img src="img/lampada.svg" style="width:170px;height:137px;opacity:.45">estúpido</div>
...
<div>
<div class="icone"><img src="img/lampada.svg" style="width:170px;height:137px">sábio</div>
...
<!--
⏱ 13:00–27:00 · BLOCOS 5a E 5b · 5b NÃO CORTAR · GÊNIO ESTÚPIDO × SÁBIO · OS DOIS LIMITES

Bloco 5a (13:00–19:00)
...
Bloco 5b (19:00–27:00), falado, sem slide próprio
...
![bg](img/gerada/escritorio-vazio.jpg)
...
<!--
⏱ 30:00–31:00 · BLOCO 7 · ESCRITÓRIO VAZIO
...
![bg](img/escritorio-equipado.jpg)
...
<!--
⏱ 31:00–35:00 · BLOCOS 7 E 8 · 8 NÃO CORTAR · ESCRITÓRIO EQUIPADO · FECHA A DÚVIDA
...
<div class="tres">
<figure><img src="img/gerada/personalizacao.jpg"><figcaption>Personalização<small>o manual</small></figcaption></figure>
<figure><img src="img/gerada/skill.jpg"><figcaption>Skill<small>o procedimento</small></figcaption></figure>
<figure><img src="img/gerada/agente.jpg"><figcaption>Agente<small>"resolve"</small></figcaption></figure>
</div>

<!--
⏱ 35:00–38:00 · BLOCO 9 · NÃO CORTAR · PERSONALIZAÇÃO, SKILL, AGENTE
...
<!--
⏱ 38:00–40:00 · BLOCO 9 · CALCULADORA × CALCULISTA
...
<!--
⏱ 40:00–41:00 · BLOCO 9 · SKILL × AGENTE
...
<div class="glossario">
<div class="termo"><img src="img/lampada.svg"><b>LLM</b><span>o gênio</span></div>
<div class="termo"><img src="img/icone-pedido.svg"><b>Prompt</b><span>o pedido</span></div>
<div class="termo"><img src="img/icone-contexto.svg"><b>Contexto</b><span>o que ele precisa saber</span></div>
<div class="termo"><img src="img/icone-papel.svg"><b>Papel</b><span>quem ele é no pedido</span></div>
<div class="termo"><img src="img/icone-esvazia.svg"><b>Janela de contexto</b><span>a lâmpada que esvazia</span></div>
<div class="termo"><img src="img/icone-inventa.svg"><b>Alucinação</b><span>inventa com confiança</span></div>
<div class="termo"><img src="img/icone-crm.svg"><b>Harness</b><span>o escritório equipado</span></div>
<div class="termo"><img src="img/icone-manual.svg"><b>Personalização</b><span>o manual</span></div>
<div class="termo"><img src="img/icone-procedimento.svg"><b>Skill</b><span>a calculadora</span></div>
<div class="termo"><img src="img/icone-resolve.svg"><b>Agente</b><span>o calculista</span></div>
<div class="termo"><img src="img/icone-conector.svg"><b>Conector</b><span>o telefone do escritório</span></div>
<div class="termo"><img src="img/icone-limite-uso.svg"><b>Limite de uso</b><span>quanto dá por período</span></div>
</div>

<!--
⏱ 41:00–43:00 · BLOCO 10 · NÃO CORTAR · REVISÃO DOS CONCEITOS
...
<div class="icone grande"><img src="img/icone-limite-uso.svg">limite de uso</div>
<div class="icone grande"><img src="img/icone-conversa-longa.svg">tamanho da conversa</div>
</div>

<div class="icones" style="margin-top:48px;align-items:center">
<div class="icone"><img src="img/icone-gratis.svg" style="width:110px;height:110px">hoje</div>
<div class="seta">→</div>
<div class="icone"><img src="img/icone-limite-uso.svg" style="width:110px;height:110px">bateu</div>
<div class="seta">→</div>
<div class="icone"><img src="img/icone-pago.svg" style="width:110px;height:110px">plano pago</div>
</div>

<!--
⏱ 43:00–47:00 · BLOCO 10 · NÃO CORTAR · ASSINATURA E LIMITES
...
<div class="cabeca"><span class="selo">demonstração · 1/5</span><h2 style="margin:0">Montar o escritório</h2></div>

<div class="passos">
<div class="passo"><span class="n">1</span><img src="img/icone-baixar.svg"><div>Baixar o Antigravity<small>antigravity.google/download</small></div></div>
<div class="passo"><span class="n">2</span><img src="img/icone-entrar.svg"><div>Entrar com a conta Google<small>@gmail pessoal</small></div></div>
<div class="passo"><span class="n">3</span><img src="img/icone-pasta.svg"><div>Criar a pasta <code>Consultor-Ademicon</code><small>e abrir como projeto</small></div></div>
</div>

<!--
⏱ 47:00–49:00 · BLOCO 11 · DEMONSTRAÇÃO GUIADA 1/5 · MONTAR O ESCRITÓRIO (2 min, no seu notebook)
...
- "Esta pasta é o escritório vazio. Vou equipar na frente de vocês; em casa, cada um monta o seu."

PLANO B
- Travou ao vivo → siga pelas notas e mostre o arquivo pronto que você preparou antes.
-->

---

<div class="cabeca"><span class="selo">demonstração · 2/5</span><h2 style="margin:0">Configurar o escritório</h2></div>
...
<!--
⏱ 49:00–53:00 · BLOCO 11 · DEMONSTRAÇÃO 2/5 · CONFIGURAR O ESCRITÓRIO (4 min)

- Cole no chat do agente, no seu Antigravity, no projeto Consultor-Ademicon, no projetor.
- O agente faz 5 perguntas antes de escrever. Responda ao vivo: "em casa, cada um responde por si."
- No fim, conferir em "…" → Customizations → Rules que as três regras aparecem como Always On. Se não aparecerem, ativar ali.
- "Isso é a personalização: o manual que o gênio lê antes de começar. Escreve uma vez. Não repetem mais."
...
<div class="cabeca"><span class="selo">demonstração · 3/5</span><h2 style="margin:0">Receber a calculadora</h2></div>
...
<!--
⏱ 53:00–55:00 · BLOCO 11 · DEMONSTRAÇÃO 3/5 · RECEBER A CALCULADORA (2 min)

- "Primeiro a calculadora: a skill, com todas as fórmulas. Colo numa conversa nova; vocês recebem no kit."
...
<div class="cabeca"><span class="selo">demonstração · 4/5</span><h2 style="margin:0">Receber o calculista</h2></div>
...
<!--
⏱ 55:00–57:00 · BLOCO 11 · DEMONSTRAÇÃO 4/5 · RECEBER O CALCULISTA (2 min)
...
<div class="cabeca"><span class="selo">demonstração · 5/5</span><h2 style="margin:0">A próxima é sua</h2></div>
...
<!--
⏱ 57:00–60:00 · BLOCO 11 · DEMONSTRAÇÃO 5/5 · A PRÓXIMA É SUA (3 min)
...
- Em casa, cada um preenche o seu.
