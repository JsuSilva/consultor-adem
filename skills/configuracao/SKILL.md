...
2. **Você (`consultor`).** Nome completo, nome curto (como assina), telefone com DDD, e-mail,
...
7. **Mercado (`mercado`).** Juros de referência do concorrente (financiamento imobiliário, CDC de
   veículo, CDC de pesados, Finame), ao mês, com fonte e data da consulta. Opcional — o
